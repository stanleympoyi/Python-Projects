...
def GuessNumberFunc():
    ...
    if UserResponse > Number:
        ...
        ResultLabel.config(
            text="You Guess Correctly! The Number was {}".format(Number), fg="Green")
...
GuessNumLabel = Label(
    MainFrame, text="Guess a number from 1 to 10:", font=("Arial", 20))
GuessNumLabel.pack()
...
GenerateNumberBtn = Button(MainFrame, text="Generate Number", width=16, font=(
    "Arial", 16), background="Dodgerblue", command=GenerateNumberFunc)
GenerateNumberBtn.pack()


# Guess Button
GuessBtn = Button(MainFrame, text="Guess", width=16, font=(
    "Arial", 16), background="#15e650", command=GuessNumberFunc)
